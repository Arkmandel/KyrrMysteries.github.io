...
function ChangeClassII(el) {
	var selected_IClass = el.options[el.selectedIndex].text;
	document.getElementById("secondaryClass").innerHTML = selected_IClass;
}
...
function ProfBonus() {
	...
	var Secondary = parseInt(document.getElementById("levelMtClass").value);
...
function UpdateTotal() {
	...
	var Secondary = parseInt(document.getElementById("levelMtClass").value);
	var Total = Primary + Secondary;
	if (document.getElementById("mtclass").checked == true) {
